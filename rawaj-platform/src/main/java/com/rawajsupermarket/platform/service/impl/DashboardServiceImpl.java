...
import com.rawajsupermarket.platform.service.DashboardService;
import com.rawajsupermarket.platform.service.DemandPredictionService;
import com.rawajsupermarket.platform.service.PricingRecommendationService;
...
public class DashboardServiceImpl implements DashboardService {
    ...
    @Override
    @Transactional(readOnly = true)
    public RawajInsightsDTO getRawajInsights(Long storeId) {
        RawajFeatureSettings flags = rawajFeatureSettingsService.getOrCreate(storeId);
        ...
        return RawajInsightsDTO.builder()
