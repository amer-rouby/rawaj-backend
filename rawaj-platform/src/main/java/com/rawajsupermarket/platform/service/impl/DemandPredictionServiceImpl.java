...
import com.rawajsupermarket.platform.dto.request.UpdatePredictionDTO;
import com.rawajsupermarket.platform.dto.response.DemandPredictionResponse;
import com.rawajsupermarket.platform.dto.request.CreateShareLinkRequest;
import com.rawajsupermarket.platform.dto.response.ReorderRecommendationDTO;
import com.rawajsupermarket.platform.dto.response.SalesHistoryPointDTO;
import com.rawajsupermarket.platform.dto.response.SupplierReorderGroupDTO;
...
import com.rawajsupermarket.platform.entity.DemandPrediction;
...
import com.rawajsupermarket.platform.repository.DemandPredictionRepository;
...
import com.rawajsupermarket.platform.service.DemandPredictionService;
...
public class DemandPredictionServiceImpl implements DemandPredictionService {
    ...
    private boolean isStockPredictionEnabled(Long storeId) {
        Boolean enabled = rawajFeatureSettingsService.getOrCreate(storeId).getStockPredictionEnabled();
    ...
    public List<ReorderRecommendationDTO> getReorderRecommendations(Long storeId) {
        Boolean enabled = rawajFeatureSettingsService.getOrCreate(storeId).getReorderRecommendationsEnabled();
    ...
    public List<SupplierReorderGroupDTO> getReorderRecommendationsBySupplier(Long storeId) {
        Boolean enabled = rawajFeatureSettingsService.getOrCreate(storeId).getSupplierRecommendationsEnabled();
        if (enabled != null && !enabled) {
