package com.rawajtechshop.settings.dto.response;
...
@NoArgsConstructor
@AllArgsConstructor
public class RawajFeatureSettingsResponse {
    ...
    public static RawajFeatureSettingsResponse fromEntity(RawajFeatureSettings settings) {
        return RawajFeatureSettingsResponse.builder()
                .id(settings.getId())
