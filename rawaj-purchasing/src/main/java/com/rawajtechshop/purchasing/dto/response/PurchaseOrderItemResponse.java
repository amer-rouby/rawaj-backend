package com.rawajtechshop.purchasing.dto.response;
...
public class PurchaseOrderItemResponse {
    ...
    public static PurchaseOrderItemResponse fromEntity(com.rawajtechshop.purchasing.entity.PurchaseOrderItem item) {
