...
import com.rawajsupermarket.catalog.repository.StockAlertRepository;
import com.rawajsupermarket.catalog.dto.response.StockAlertResponse;
import com.rawajsupermarket.catalog.service.StockAlertService;
...
public class StockAlertServiceImpl implements StockAlertService {
    ...
    public void generateExpiryAlerts(Long storeId) {
        ...
        for (StockBatch batch : expiredBatches) {
            if (batch.getStatus() != com.rawajsupermarket.catalog.entity.StockBatch.BatchStatus.DISCARDED) {
                try {
        ...
        for (StockBatch batch : expiringBatches) {
            ...
            if (batch.getStatus() == com.rawajsupermarket.catalog.entity.StockBatch.BatchStatus.ACTIVE) {
                try {
                    Product product = batch.getProduct();
                    if (product == null) continue;
