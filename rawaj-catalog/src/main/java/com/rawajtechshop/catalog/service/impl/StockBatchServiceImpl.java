package com.rawajtechshop.catalog.service.impl;
...
import com.rawajtechshop.catalog.entity.StockAdjustmentHistory;
import com.rawajtechshop.catalog.dto.response.StockAdjustmentHistoryDTO;
import com.rawajtechshop.catalog.repository.StockAdjustmentHistoryRepository;
...
import com.rawajtechshop.catalog.service.StockBatchService;
...
public class StockBatchServiceImpl implements StockBatchService {
    ...
    private void notifyRealtimeStockChange(Long storeId, StockBatchResponse batch, String changeType) {
        try {
            ...
            eventPublisher.publishEvent(new StockChangedEvent(storeId, changeType, batch));
        } catch (Exception e) {
