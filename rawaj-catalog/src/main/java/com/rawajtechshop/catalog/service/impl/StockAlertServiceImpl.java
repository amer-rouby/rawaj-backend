...
import com.rawajtechshop.catalog.dto.response.AlertStatsResponse;
import com.rawajtechshop.catalog.entity.Product;
import com.rawajtechshop.catalog.repository.ProductRepository;
import com.rawajtechshop.catalog.entity.StockAlert;
import com.rawajtechshop.catalog.repository.StockAlertRepository;
import com.rawajtechshop.catalog.dto.response.StockAlertResponse;
import com.rawajtechshop.catalog.service.StockAlertService;
...
public class StockAlertServiceImpl implements StockAlertService {
    ...
    public void generateExpiryAlerts(Long storeId) {
        ...
        for (StockBatch batch : expiredBatches) {
            if (batch.getStatus() != com.rawajtechshop.catalog.entity.StockBatch.BatchStatus.DISCARDED) {
                try {
        ...
        for (StockBatch batch : expiringBatches) {
            ...
            if (batch.getStatus() == com.rawajtechshop.catalog.entity.StockBatch.BatchStatus.ACTIVE) {
                try {
                    Product product = batch.getProduct();
                    if (product == null) continue;
