package com.rawajtechshop.sales.service.impl;
...
import com.rawajtechshop.sales.dto.request.SaleItemRequest;
import com.rawajtechshop.sales.dto.request.SaleRequest;
import com.rawajtechshop.sales.entity.SaleTransaction;
import com.rawajtechshop.sales.dto.response.SaleTransactionDTO;
import com.rawajtechshop.sales.repository.SaleTransactionRepository;
import com.rawajtechshop.sales.service.SaleTransactionService;
...
public class SaleTransactionServiceImpl implements SaleTransactionService {
    ...
    public SaleTransactionDTO createSale(SaleRequest request, Long currentUserId) {
        ...
        if (isCreditSale) {
            Boolean creditEnabled = rawajFeatureSettingsService.getOrCreate(request.getStoreId()).getCustomerCreditEnabled();
