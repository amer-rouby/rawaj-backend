...
import com.rawajsupermarket.dto.response.AlertStatsResponse;
import com.rawajsupermarket.dto.response.StockAlertResponse;
import com.rawajsupermarket.entity.Store;
import com.rawajsupermarket.entity.Product;
import com.rawajsupermarket.entity.StockAlert;
...
import com.rawajsupermarket.repository.StockAlertRepository;
import com.rawajsupermarket.repository.StockBatchRepository;
import com.rawajsupermarket.service.StockAlertService;
...
public class StockAlertServiceImpl implements StockAlertService {
    ...
    public void generateExpiryAlerts(Long storeId) {
        ...
        for (StockBatch batch : expiredBatches) {
            if (batch.getStatus() != com.rawajsupermarket.entity.StockBatch.BatchStatus.DISCARDED) {
                try {
        ...
        for (StockBatch batch : expiringBatches) {
            ...
            if (batch.getStatus() == com.rawajsupermarket.entity.StockBatch.BatchStatus.ACTIVE) {
                try {
                    Product product = batch.getProduct();
                    if (product == null) continue;
