...
import com.rawajsupermarket.dto.request.StockAdjustmentRequest;
import com.rawajsupermarket.dto.request.StockBatchRequest;
import com.rawajsupermarket.dto.response.StockAdjustmentHistoryDTO;
import com.rawajsupermarket.dto.response.StockBatchResponse;
...
import com.rawajsupermarket.service.StockBatchService;
...
public class StockBatchServiceImpl implements StockBatchService {
    ...
    private void notifyRealtimeStockChange(Long storeId, StockBatchResponse batch, String changeType) {
        try {
            Boolean enabled = rawajFeatureSettingsService.getOrCreate(storeId).getRealtimeUpdatesEnabled();
