var r=`#4338ca`;var a=`#1e293b`;var i=`#64748b`;var s=`#cbd5e1`;var l=`#f1f5f9`;function p(t){return t?`'Tahoma', 'Segoe UI', Arial, sans-serif`:`'Segoe UI', Roboto, Arial, sans-serif`}function g(t){let e=t?`rtl`:`ltr`,o=t?`right`:`left`;return`
    * { margin: 0; padding: 0; box-sizing: border-box; }
    html, body { font-family: ${p(t)}; color: ${a}; background: #fff; }
    body { direction: ${e}; padding: 12mm 10mm; font-size: 12px; line-height: 1.5; }
  ...
  `}function c(t,e,o,n){let d=[t.address,t.phone,t.email].filter(Boolean);return`
    <header class="letterhead">
      ...
      ${n?`<div class="doc-meta">${n}</div>`:``}
    </header>
  `}function m(t,e,o){return`<footer class="doc-footer">${t}&nbsp;&mdash;&nbsp;${e}: ${new Date().toLocaleString(o?`ar-EG`:`en-US`,{year:`numeric`,month:`long`,day:`numeric`,hour:`2-digit`,minute:`2-digit`})}</footer>`}export{g as n,m as r,c as t};