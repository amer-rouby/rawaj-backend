import{Jn as c,Ri as u_,pi as pe}from"./chunk-BiI_Tx0v.js";import{c as wi}from"./chunk-BiDByBCW.js";import{n as o}from"./main-TQOHQKMG.js";import{t as g}from"./chunk-KIAMiGCR.js";import{n as g$1,r as m,t as c$1}from"./chunk-oiu4eLtI.js";var S=class c$2{translate=c(u_);languageService=c(o);currencyService=c(g);authService=c(wi);printReport(t){let e=this.languageService.getCurrentLanguage()===`ar`,n=t.direction||(e?`rtl`:`ltr`),l=e?`ar`:`en`,s=o=>{let r=this.translate.instant(o);return r&&r!==o?r:o},d=this.generatePrintHtml(t,s,e,n,l),a=document.createElement(`iframe`);a.style.display=`none`,a.src=`about:blank`,document.body.appendChild(a);let i=a.contentDocument||a.contentWindow?.document;i&&(i.open(),i.write(d),i.close(),a.onload=()=>{setTimeout(()=>{a.contentWindow?.print(),setTimeout(()=>{document.body.removeChild(a)},100)},300)})}generatePrintHtml(t,e,n,l,s){let d=t.summary?.length?`
    ...
    `,i=this.authService.getStoreInfo()?.name||e(`APP.NAME`),o=`${e(`REPORTS.GENERATED`)||`Generated`}: ${new Date().toLocaleDateString(s===`ar`?`ar-EG-u-nu-latn`:`en-US`,{year:`numeric`,month:`long`,day:`numeric`,hour:`2-digit`,minute:`2-digit`})}`;return`<!DOCTYPE html>
<html dir="${l}" lang="${s}">
<head>
  <meta charset="UTF-8">
  <title>${t.title}</title>
...
</html>`}formatValue(t,e,n){if(t==null)return`-`;switch(e){case`currency`:return new Intl.NumberFormat(n?`ar-EG-u-nu-latn`:`en-US`,{style:`currency`,currency:this.currencyService.getCode(),minimumFractionDigits:2}).format(t);case`number`:return new Intl.NumberFormat(n?`ar-EG-u-nu-latn`:`en-US`).format(t);case`date`:try{return new Date(t).toLocaleDateString(n?`ar-EG-u-nu-latn`:`en-US`,{year:`numeric`,month:`short`,day:`numeric`})}catch(l){return t}default:return t}}static ɵfac=function(e){return new(e||c$2)};static ɵprov=pe({token:c$2,factory:c$2.ɵfac,providedIn:`root`})};export{S as t};